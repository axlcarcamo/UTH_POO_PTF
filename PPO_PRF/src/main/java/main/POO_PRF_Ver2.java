...
public class POO_PRF_Ver2 {
  public static void main(String[] args) {
	  Scanner tD=new Scanner(System.in);
		
    // Declaracion de arreglos
    String [][] dppN =new String[3][6]; // dppn= Datos partido politico
    
 /*	
    Descripcion del arreglo registro de candidato para presidente.
		0				1			             2                  3                  4
    Fila 0   Nombre      edad (debe ser >30 años si es para presidente)		nacionalidad	fecha de nacimiento     Direccion
    Fila 1   Nombre      edad (debe ser >30 años si es para presidente)		nacionalidad	fecha de nacimiento     Direccion 
    Fila 2   Nombre      edad (debe ser >30 años si es para presidente)		nacionalidad	fecha de nacimiento     Direccion
 */
    
    
    
    // Datos tipo entero seleccion he interpretacion de Switch
   ...
   /* Banner correspondiente a la univerisidad */
	  ...
	  switch (op1) {
		  case 1:
			  ...
			  System.out.println(" Ingrese el valor segun el partido politico a quien inscribira un candidato:                 ");
			  ...
			  switch (op2){
				  case 1:
					  System.out.println(" ============================================================================================");
					  System.out.println(" ====================== REGISTRO DE CANDIDATO PARTIDO NATURALEZA ============================");
					  System.out.println(" ============================================================================================");
				 	  System.out.println(" Necesitamos datos generales del candidato:                                               ");
					  tD.nextLine();
					  System.out.println(" Ingrese el nombre completo: ");  dppN[0][0]=tD.nextLine();
					  System.out.println(" Ingrese la nacionalidad: "); dppN[0][1]=tD.nextLine();
					  System.out.println(" Ingrese la estado civil: "); dppN[0][2]=tD.nextLine();
					  System.out.println(" Ingrese ciudad de origen: "); dppN[0][3]=tD.nextLine();  
					  System.out.println(" Ingrese la direccion exacta de su residencia "); dppN[0][4]=tD.nextLine();
					  do{
					  System.out.println(" Ingrese la edad: "); psE1=tD.nextInt();
					  } while (psE1<30 || psE1>70);
					  System.out.println(" ============================================================================================");
					  ...
					  System.out.println(" ||       Nombre    : " + dppN[0][0] + "                                                   ||");
					  System.out.println(" ||         Edad    : " + psE1 + " Años                                                    ||");
					  System.out.println(" || Nacionalidad    : " + dppN[0][1]+ "                                                    ||");
					  System.out.println(" || Estado Civil    : " + dppN[0][2]+ "                                                    ||");
					  System.out.println(" || Ciudad de Origen: " + dppN[0][3] + "                                                   ||");
					  System.out.println(" ||        Direccion: " + dppN[0][4] + "                                                   ||");
					  System.out.println(" ============================================================================================");
					  System.out.println("                            Inscripcion realizada sin errores                               ");
					  System.out.println(" ============================================================================================");
					  System.out.println("");
					  do {
					  System.out.println(" ============================================================================================");
					  System.out.println("                     DESEA REGISTRAR OTRO CANDIDATO PARA LA PRESINDENCIA                     ");
					  System.out.println(" ============================================================================================");
					  ...
					  switch (op3){
						  case 1:
							...
							System.out.println(" ============================================================================================");
						        ...
						        System.out.println(" ============================================================================================");
						        System.out.println("");
							System.out.println(" Bienvenido al registro de candidatos donde le comentamos que existen unicamente 2 partidos  ");
					                System.out.println(" los cuales requieren representantes aun los cuales se encuentran abajo descritos            ");
							System.out.println(" Ingrese el valor segun el partido politico a quien inscribira un candidato:                 ");
							System.out.println(" 01 Partido Nuevo amanecer ");
							System.out.println(" 02 Partido Light Blues    ");
							System.out.println(" 03 Salir ");
							System.out.println(" ============================================================================================");
						        System.out.println(" Su opcion ingresada es: ");
							op4 = tD.nextInt();
							     }while (op4 > 3 && op2 < 0);// llave de cierre do While seleccion de partido politico 
							  
							switch (op4){
								case 1: 
								System.out.println(" ============================================================================================");
								System.out.println(" ====================== REGISTRO DE CANDIDATO PARTIDO NUEVO AMANECER ========================");
								System.out.println(" ============================================================================================");
								System.out.println(" Necesitamos datos generales del candidato:                                               ");
								tD.nextLine();
								System.out.println(" Ingrese el nombre completo: "); dppN[1][0] = tD.nextLine();
								System.out.println(" Ingrese la nacionalidad: "); dppN[1][1] = tD.nextLine();
								System.out.println(" Ingrese la estado civil: "); dppN[1][2] = tD.nextLine();
								System.out.println(" Ingrese ciudad de origen: "); dppN[1][3] = tD.nextLine();
								System.out.println(" Ingrese la direccion exacta de su residencia "); dppN[1][4] = tD.nextLine();
								do {
								System.out.println(" Ingrese la edad: ");
								psE2 = tD.nextInt();
								}
								while (psE2 < 30 || psE2 > 70);
								System.out.println(" ============================================================================================");
						         	System.out.println(" Datos ingresados correctamente su candidato fue inscrito para la participacion electoral   ");
								System.out.println(" ================================== Detalles registrados ====================================");
								System.out.println(" ||       Nombre    : " + dppN[1][0] + "                                                   ||");
								System.out.println(" ||         Edad    : " + psE2 + " Años                                                    ||");
								System.out.println(" || Nacionalidad    : " + dppN[1][1] + "                                                    ||");
								System.out.println(" || Estado Civil    : " + dppN[1][2] + "                                                    ||");
								System.out.println(" || Ciudad de Origen: " + dppN[1][3] + "                                                   ||");
								System.out.println(" ||        Direccion: " + dppN[1][4] + "                                                   ||");
								System.out.println(" ============================================================================================");
								System.out.println("                            Inscripcion realizada sin errores                               ");
								System.out.println(" ============================================================================================");
								System.out.println("");
								...
								switch (op5){
									case 1:
										System.out.println(" ============================================================================================");
										System.out.println(" ======================   REGISTRO DE CANDIDATO PARTIDO LIGHT BLUES  ========================");
										System.out.println(" ============================================================================================");
										System.out.println(" Necesitamos datos generales del candidato:                                               ");
										tD.nextLine();
										System.out.println(" Ingrese el nombre completo: "); dppN[2][0] = tD.nextLine();
										System.out.println(" Ingrese la nacionalidad: "); dppN[2][1] = tD.nextLine();
										System.out.println(" Ingrese la estado civil: "); dppN[2][2] = tD.nextLine();
										System.out.println(" Ingrese ciudad de origen: "); dppN[2][3] = tD.nextLine();
										System.out.println(" Ingrese la direccion exacta de su residencia "); dppN[1][4] = tD.nextLine();
										do {
										System.out.println(" Ingrese la edad: ");
										psE3 = tD.nextInt();
										}
										while (psE3 < 30 || psE3 > 70);
										System.out.println(" ============================================================================================");
										System.out.println(" Datos ingresados correctamente su candidato fue inscrito para la participacion electoral   ");
										System.out.println(" ================================== Detalles registrados ====================================");
										System.out.println(" ||       Nombre    : " + dppN[2][0] + "                                                   ||");
										System.out.println(" ||         Edad    : " + psE3 + " Años                                                    ||");
										System.out.println(" || Nacionalidad    : " + dppN[2][1] + "                                                    ||");
										System.out.println(" || Estado Civil    : " + dppN[2][2] + "                                                    ||");
										System.out.println(" || Ciudad de Origen: " + dppN[2][3] + "                                                   ||");
										System.out.println(" ||        Direccion: " + dppN[2][4] + "                                                   ||");
										System.out.println(" ============================================================================================");
										System.out.println("                            Inscripcion realizada sin errores                               ");
										System.out.println(" ============================================================================================");
										System.out.println("");
									...
									case 2:
										System.out.println(" ===========================================================================================");
			                                                        System.out.println("                                  SALIR DEL SOFTWARE                                        ");
			                                                        System.out.println(" ===========================================================================================");
										break:
									default:
										break:
